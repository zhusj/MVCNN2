...
diary 'run_log_test_expr10_(1-2)'
echo on
...
save('results_exp10_52-10-(1-2)','reconstruction_error','letter_est_results','style_est_results','letter_error_percent','speaker_error_percent');
