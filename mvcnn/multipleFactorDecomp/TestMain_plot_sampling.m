function TestMain_plot_sampling(p_data_file,p_use_sampling,p_use_wts)
...
style_labels = (1:length(style_bases))';
fig = plotting(letter_bases(:,1:3),ltr_labels);
...
for k = 1:1
    ...
    for li = 1:numofletters
        for si=1:numofstyles
            ...
            letter_act_labels(est_index) = li;
            ...
            if(p_use_wts)
                ...
                ltr = knnclassify(l',letter_bases,ltr_labels,4);
