...
disp 'train over reptns 2,3 and test over reptn 1'
subjects = {'*'}
letters = {'*'}
repeats = {'1'}
...
if nargin<2
    % % load test data
    load('AVLetter_Learn_HOSVD_52-10-(2-3)');
...
save('results_52-10-(2-3)_NEW','reconstruction_error','letter_est_results','style_est_results','letter_recog_rate','speaker_iden_rate','estimated_letter_vector','estimated_letter_label');
