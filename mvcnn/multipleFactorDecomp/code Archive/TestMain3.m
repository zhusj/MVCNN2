...
for li = 1:numofletters
    for si=1:numofstyle
        ...
        %B = CF*u{3}';
        b = reshape(CF,[],1);
        %% step: iterate for all persons and by knowing the correct letter vector
        %choose the peson with letter has min reconstruction error
        err_min = inf;
