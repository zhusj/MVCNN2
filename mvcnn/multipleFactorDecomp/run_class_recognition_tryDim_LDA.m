function run_class_recognition_tryDim_LDA(class_dim,split_dim,pd_range,classification,generate_new_learn_model,generate_new_split)
...
for pd = pd_range
    ...
    if ~exist([model_file '.mat'],'file') || generate_new_learn_model
        model_file = learn_LDA_SVM(run_stamp1,splittedDataFile,class_dim,pd,0,split_dim_name);
    end
...
%     end
    recog_rate = Test_LDA(run_stamp1,model_file,splittedDataFile,class_dim,classifier);
