...
% ex(end+1).trainOpts = struct(...
%     'baseModel', 'imagenet-vgg-m-finetuned-ModelNet40v1-BS60_AUGnone', ... 
%     'dataset', 'ModelNet40v1', ...
%     'batchSize', 60, ... 
%     'aug', 'none', ...
%     'numEpochs', 10, ...
...
%     end
    ...
    % ---------------------------------------------------------------------
    clear feats;
    ex(i).featOpts.model = 'imagenet-vgg-m';
    if isfield(ex(i),'featOpts') && ~skipEval,
        ...
        feats = imdb_compute_cnn_features_save(featOpts.dataset, featOpts.model, ...
